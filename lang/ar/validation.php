...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'subtitle.ar' => 'العنوان الفرعي بالعربي',
        'subtitle.en' => 'العنوان الفرعي بالإنجليزي',
        ...
        'btn_text.ar' => 'نص الزر بالعربي',
        'btn_text.en' => 'نص الزر بالإنجليزي',
        'content.ar' => 'المحتوى بالعربي',
        'content.en' => 'المحتوى بالإنجليزي',
        'rating' => 'التقييم',
        'user_name' => 'الاسم الكامل',
        'user_phone' => 'رقم الهاتف',
        'user_email' => 'البريد الإلكتروني',
        'selected_country_id' => 'الدولة',
        'selected_city_id' => 'المحافظة / المنطقة',
        'city_text' => 'المدينة / المنطقة السكنية',
