        ...
        <div class="modal-content shadow-premium border-0">
            <div class="modal-header border-bottom-0 pb-0">
                <h5 class="modal-title d-flex align-items-center" id="flagsReferenceModalLabel">
                    ...
                    <span class="fw-bold"><?php echo __('addresses.flag_codes_reference'); ?></span>
                </h5>
                ...
                <div class="form-group mb-4 theme-primary px-1">
                    <div class="input-group-premium shadow-sm">
                        ...
                        <input type="text" id="flagSearchInput" class="form-control"
                            placeholder="<?php echo __('addresses.search_for_country'); ?>">
                    </div>
                </div>
                    ...
                    <table class="table table-hover align-middle mb-0" id="flagsRefTable">
                        <thead>
                            <tr>
                                ...
                                <th class="text-start" style="width: 60px;"><?php echo __('general.flag'); ?></th>
                                <th class="text-start"><?php echo __('addresses.country_name'); ?></th>
                                <th class="text-center" style="width: 100px;"><?php echo __('addresses.flag_code'); ?></th>
                            </tr>
                        </thead>
                        <tbody>
...
<?php $__env->startPush('scripts'); ?>
    <script>
        $(document).ready(function() {
            ...
            let targetInputId = '';
            const currentLocale = "<?php echo app()->getLocale(); ?>";
                ...
                if (filtered.length === 0) {
                    tbody.append(
                        `<tr><td colspan="4" class="text-center py-5 text-muted small">
                            ...
                            <?php echo __('general.no_record_found'); ?>
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\laragon\www\market\resources\views/dashboard/addresses/countries/modals/flags_reference.blade.php ENDPATH**/ ?>