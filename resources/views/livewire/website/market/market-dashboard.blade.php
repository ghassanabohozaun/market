    ...
    <div class="p-4">
        <div class="grid grid-cols-2 gap-3 mb-2">
            <div class="col-span-2 bg-gradient-to-br from-emerald-500 to-teal-700 rounded-3xl p-6 text-white shadow-lg shadow-emerald-500/30 relative overflow-hidden transition-transform duration-300 hover:scale-[1.01]">
                ...
                <p class="text-sm opacity-90 mb-1 font-medium">{{ __('market.total_market_debts') }}</p>
                <h2 class="text-4xl font-black tracking-tight"><span>{{ number_format($totalDebt, 1) }}</span> <span class="text-lg font-normal opacity-80">{{ __('market.currency') }}</span></h2>
            </div>
            ...
            <div class="bg-white dark:bg-darkCard rounded-[1.25rem] p-4 shadow-sm border border-gray-100 dark:border-gray-800 flex items-center gap-3 transition-colors">
                ...
                <div>
                    <p class="text-xs text-gray-500 dark:text-gray-400 font-medium whitespace-nowrap">{{ __('market.today_collections') }}</p>
                    <h4 class="text-lg font-black text-gray-800 dark:text-gray-100 leading-tight">{{ number_format($todayCollections, 1) }} <span class="text-[10px] font-normal text-gray-500">{{ __('market.currency') }}</span></h4>
                </div>
            </div>
        </div>
    </div>
