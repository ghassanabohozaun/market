                    ...
                    <div class="d-md-flex align-items-center justify-content-between border-bottom mb-3">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">{!! __('testimonials.testimonials') !!}</li>
                            </ol>
                        </nav>
                        <div class="btn-wrapper mt-3 mt-sm-0">
                            <button type="button" class="btn btn-primary text-white me-0" data-bs-toggle="modal"
                                ...
                                <i class="icon-plus"></i> {!! __('testimonials.create_new') !!}
                            </button>
                        </div>
                    </div>
                            ...
                            <div class="card card-rounded mt-1">
                                <div class="card-body">
                                    ...
                                    <div class="table-loader-container" style="position: relative;">
                                        ...
                                        <div id="table_data">
                                            @include('dashboard.testimonials.partials._table', [
...
@push('modals')
    @include('dashboard.testimonials.modals.create')
    @include('dashboard.testimonials.modals.edit')
