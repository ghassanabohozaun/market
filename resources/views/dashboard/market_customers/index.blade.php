        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="home-tab">
                    <div class="d-md-flex align-items-center justify-content-between border-bottom mb-3">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">{!! __('market.customers') !!}</li>
                            </ol>
                        </nav>
                        <div class="btn-wrapper mt-3 mt-sm-0">
                            <button type="button" class="btn btn-primary text-white me-0" data-bs-toggle="modal"
                                data-bs-target="#createMarketCustomerModal">
                                <i class="icon-plus"></i> {!! __('market.create_new_customer') !!}
                            </button>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            @include('dashboard.market_customers.partials._search')
                            ...
                            <div class="card card-rounded mt-1">
                                <div class="card-body">
                                    ...
                                    <div class="table-loader-container" style="position: relative;">
                                        ...
                                        <div id="table_data">
                                            @include('dashboard.market_customers.partials._table', [
                                                'market_customers' => $market_customers,
                                            ])
                                        </div>
                                    </div>
                                </div>
...
@endsection
    ...
    @push('modals')
        @include('dashboard.market_customers.modals.create')
        @include('dashboard.market_customers.modals.edit')
