...
<div class="query-bar-container">
    <div class="query-bar js-query-bar">
        ...
        <form class="js-filter-form d-flex align-items-center gap-2">
            ...
            <div class="filter-chip js-filter-chip" data-target="governorate_popover">
                <i class="mdi mdi-office-building"></i>
                <span class="chip-text">{!! __('addresses.governorate_name') !!}</span>
                <div class="filter-popover" id="governorate_popover">
                    <div class="mb-3 theme-info">
                        <label class="form-label d-block fw-bold mb-1">{!! __('addresses.governorate_name') !!}</label>
                        <div class="input-group-premium select2-premium">
                            <span class="input-group-text"><i class="mdi mdi-city"></i></span>
                            <select class="form-control" name="governorate_id" style="width: 100%">
            ...
            $('.js-filter-chip').on('click', function(e) {
                ...
                if (!isVisible) {
                    $popover.fadeIn(200, function() {
                        ...
                        // Init Select2 if governorate_popover
                        if ($popover.attr('id') === 'governorate_popover') {
