        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="home-tab">
                    ...
                    <div class="d-md-flex align-items-center justify-content-between border-bottom mb-3">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">{!! __('sliders.create_new_slider') !!}</li>
                            </ol>
                        </nav>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <form id="createSliderForm" action="{!! route('dashboard.sliders.store') !!}" method="post"
                                        ...
                                        <div class="row g-4">
                                                ...
                                                <div class="form-group mb-0">
                                                    ...
                                                    <div class="input-group-premium">
                                                        ...
                                                        <input type="text" id="title_ar" name="title[ar]"
                                                            class="form-control" placeholder="{!! __('sliders.enter_title_ar') !!}"
                                                            autocomplete="off">
                                                    </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group position-relative">
                                                    <label class="form-label-premium" for="subtitle_ar">{!! __('sliders.subtitle_ar') !!} <span
                                                            class="text-danger">*</span></label>
                                                    <div class="input-group input-group-premium">
                                                        <span class="input-group-text"><i
                                                                class="mdi mdi-format-title text-primary"></i></span>
                                                        <input type="text" id="subtitle_ar" name="subtitle[ar]"
                                                            class="form-control" placeholder="{!! __('sliders.enter_subtitle_ar') !!}">
                                                    </div>
                                                    <strong id="subtitle_ar_error" class="text-danger small"></strong>
                                                </div>
                                            </div>
                                            <!-- English Title -->
                                                ...
                                                <div class="form-group mb-0">
                                                    ...
                                                    <div class="input-group-premium">
                                                        ...
                                                        <input type="text" id="title_en" name="title[en]"
                                                            class="form-control" placeholder="{!! __('sliders.enter_title_en') !!}"
                                                            autocomplete="off">
                                                    </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group position-relative">
                                                    <label class="form-label-premium" for="subtitle_en">{!! __('sliders.subtitle_en') !!} <span
                                                            class="text-danger">*</span></label>
                                                    <div class="input-group input-group-premium">
                                                        <span class="input-group-text"><i
                                                                class="mdi mdi-format-title text-primary"></i></span>
                                                        <input type="text" id="subtitle_en" name="subtitle[en]"
                                                            class="form-control" placeholder="{!! __('sliders.enter_subtitle_en') !!}">
                                                    </div>
                                                    <strong id="subtitle_en_error" class="text-danger small"></strong>
                                                </div>
                                            </div>
                                                ...
                                                <div class="form-group mb-0">
                                                    ...
                                                    <div class="input-group-premium">
                                                        ...
                                                        <input type="text" id="url_ar" name="url[ar]"
                                                            class="form-control" placeholder="{!! __('sliders.enter_url_ar') !!}">
                                                    </div>
                                                ...
                                                <div class="form-group mb-0">
                                                    ...
                                                    <div class="input-group-premium">
                                                        ...
                                                        <input type="text" id="url_en" name="url[en]"
                                                            class="form-control" placeholder="{!! __('sliders.enter_url_en') !!}">
                                                    </div>
                                            ...
                                            <div class="col-md-12">
                                                <x-dashboard.file-input name="photo" id="create_slider_photo_input"
                                                    ...
                                                    placeholderText="1920 × 742" isRequired="false"
                                                    errorId="photo_error" />
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="form-check form-switch mb-0">
                                                                ...
                                                                <input type="checkbox" class="form-check-input m-0" role="switch"
                                                                    ...
                                                                    checked style="width: 2.5rem; height: 1.25rem; cursor: pointer;">
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="form-check form-switch mb-0">
                                                                ...
                                                                <input type="checkbox" class="form-check-input m-0" role="switch"
                                                                    ...
                                                                    value="1" checked style="width: 2.5rem; height: 1.25rem; cursor: pointer;">
                                                            </div>
                                                        </div>
                                                    </div>
                                ...
                                <x-dashboard.command-hud formId="createSliderForm" />
                            </form>
                        </div>
                    </div>
                </div>
...
@push('scripts')
    <script>
        $(document).ready(function() {
            // Initialize HUB
            initHud('createSliderForm');

            // Handle Form Submission
            window.handleFormSubmit('#createSliderForm', {
